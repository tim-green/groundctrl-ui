  ...
  notify(place) {
    ...
    options = {
      ...
      message: (
        <div>
          <div>
            Welcome to <b>UI Dashboard made with React</b> 
          </div>
        </div>
      ),
      type: type,
      icon: "ground-ui-icons ui-1_bell-53",
      autoDismiss: 7
    };
        ...
        <div className="content">
          ...
          <Row>
            <Col md={12} xs={12}>
              <Card>
                 <CardHeader>
                  <h3 className="title">Notifications Style</h3>
                </CardHeader>
                <CardBody>
                  <Alert color="info">
                  ...
                  >
                    <span
                      data-notify="icon"
                      className="ground-ui-icons ui-1_bell-53"
                    />
